...
!function(a, b, c) {
    ...
    f("colon", {
        ...
        for (var g, h, i = a, j = d.toString().split("."), k = 0, l = j.length; l > k; ++k) {
            if (!(j[k] in i)) return;
            g = j[k], h = i, i = i[g];
        }
    ...
    colon.throttle = function(b, c, d) {
        ...
        process: function() {
            ...
            for (g in i) h = i[g], a = h[0], c = h[1], d = h[2], e = h[3], (!d || j * k >= d * (e + 1)) && (f = a.call(c, e), 
        ...
        id: function(c, d, e) {
            ...
            a.FormData && e instanceof FormData ? null : (e && (f = -1 === d.indexOf("?") ? "?" : "&"), 
        ...
        to: function(d, e, f, g) {
            var h, i, j, k = null;
            return g || (g = {}), a.FormData && f instanceof FormData ? (g.ajaxSettings || (g.ajaxSettings = {}), 
            g.ajaxSettings.contentType = !1, g.ajaxSettings.processData = !1) : "object" === b.type(f) && (f = colon.query.slim(f)), 
            "GET" === d && (g.cache === c && (g.cache = 1e4), g.cache && (h = colon.storeObject(g.cache, this.id(d, e, f)), 
            h && (i = h()) && "..." !== i)) ? colon.async(i, "cache", null, h) : (j = this.unite(k, function() {
        ...
        targetUser: function(a) {
            ...
            switch (b.type(a)) {
              case "array":
                return -1 !== b.inArray(+h.user.id.slice(-1), a);
        ...
        var e = "==" === b ? a == c : "<" === b ? c > a : "<=" === b ? c >= a : ">" === b ? a > c : ">=" === b ? a >= c : "&&" === b ? a && c : "||" === b ? a || c : !1;
        ...
        if (a && a.length) {
            for (var f = 0, g = a.length; g > f; ++f) e[f] = c(a[f]);
        ...
        var e = " _work";
        if ("0" === b) {
            if (parseInt(a) < parseInt(h.context.imfIllustEnbledTimeStamp)) return e;
        } else if ("1" === b) {
            if (parseInt(a) < parseInt(h.context.imfMangaEnbledTimeStamp)) return e;
            e += " manga";
        } else "2" === b && (e += " ugoku-illust");
        return parseInt(c) > 1 && (e += " multiple", "1" === d ? e += " rtl" : "2" === d && (e += " ltr")), 
        e;
    }), function(a) {
        a.fn.dataset = function(b, d) {
            ...
            if (b === c) {
                ...
                for (var f, g = {}, h = this[0].attributes, i = 0, j = h.length; j > i; ++i) f = h[i], 
        ...
        cookie: function(e, f, g) {
            if (e) switch (f) {
              case c:
                var h = d.cookie;
                if (h && "" !== h) for (var i, j = h.split(";"), k = 0, l = j.length; l > k; ++k) if (i = b.trim(j[k]), 
        ...
        cleanup: function() {
            if (colon.test.storage) {
                var b, d, e, f = [];
                for (b = 0, d = a.localStorage.length; d > b; ++b) f[b] = a.localStorage.key(b);
                for (b = 0, d = f.length; d > b; ++b) e = f[b], colon.storage.parse(a.localStorage.getItem(e)) === c && colon.storage.localStorage(e, null);
            }
        },
        id: function(a) {
        ...
        popupPosition: function(a, d, e) {
            ...
            p + m + f > l && s - i > l - (s + t) && (p = l - m - f), h + n + f + g > r && h + k >= r + u + n + f + g ? (o = r + u + g, 
            a.addClass("under-target")) : (o = r - n - g, a.removeClass("under-target")), e.nipple && (v = b(e.nipple, a), 
            x = e.nippleMargin || 0, y = v.outerWidth(), y + 2 * x > p + m - s || y + 2 * x > s + t - p ? v.addClass("_hidden") : (w = t / 2, 
        ...
        var d, e = /^"(.+)"$/.exec(a), f = [];
        e && (a = e[1]);
        for (var g = 0, h = b.length; h > g; ++g) d = colon.ui.Tag.trim(b[g]).toLowerCase(), 
        ...
        update: function(a) {
            ...
            return /[\s　]$/.test(d) || f || "blur" === a.type ? (c = colon.ui.Tag.split(d), 
            c.length && (this.input.val(""), this.recentValue = "", this.add(c))) : "keyup" !== a.type || "" !== this.recentValue || a.which !== colon.ui.shortcut.keyList.DELETE || e ? this.recentValue = d : (d = b("li", this.tagsContainer).eq(-1).attr("data-tag"), 
            d && this.remove(d)), f ? !1 : void 0;
        },
        ...
        add: function(a) {
            ...
            for (var d = 0, e = a.length; e > d; ++d) {
                ...
                if (f) {
                    ...
                    -1 === g && (this.tagsContainer.append(colon.template("ui-tag-item", {
                        tag: f
        ...
        remove: function(a) {
            var c;
            return a = colon.ui.Tag.trim(a), c = colon.ui.Tag.find(a, this.tags), -1 === c ? !1 : (b("li", this.tagsContainer).eq(c).remove(), 
        ...
        parse: function(a, d) {
            ...
            g = i.slice(1).split(".").slice(1), j = [ f, /ctrl/i.test(e), /alt/i.test(e), /shift/i.test(e), g.length ? g : c ], 
        ...
        find: function(a, b, d) {
            var e, f, g = [];
            for (e = a.length - 1; f = a[e]; --e) !b[0] && !b[4] || (b[0] ? b[0] !== f[0] || b[1] !== f[1] || b[2] !== f[2] || b[3] !== f[3] : 0) || (b[4] ? !this.findNamespace(a, f[4] || [], b) : 0) || (g.push(e), 
            d && d.call(this, f, e));
            return g.length ? g : c;
        },
        findNamespace: function(a, d, e) {
            ...
            for (f = 0; h = d[f]; ++f) if (e) {
                if (-1 !== b.inArray(h, e[4])) return !0;
            } else for (g = 0; e = a[g]; ++g) -1 !== b.inArray(h, e[4]) && i.push(g);
            return i.length ? i : c;
        }
    }), f("colon.ui.modal", {
        modals: [],
        ...
        get: function(a, b) {
            ...
            if (a) {
                var d = this.find(c, a);
                return -1 !== d ? b ? c.splice(d, 1)[0] : c[d] : null;
            }
        ...
        push: function(a, c) {
            var d, e;
            return a = b(a), this.paused || !a.length ? null : (d = colon.id(), c || (c = {}), 
            (!this.modals.length || !this.get().options.block) && this.pop(), this.initialized || this.initialize(), 
            e = this.modals.push({
                id: d,
                target: a,
                options: c
        ...
        next: function(a, b) {
            return this.pop(), this.push(a, b);
        },
        close: function(a) {
            var b, c, d;
            this.paused || (this.clickTarget = null, this.modals.length && (b = a ? this.get(a, !0) : this.modals.pop(), 
            b && (c = b.target, d = b.options, d.block && (h.scrollView.remove(".ui-scroll-view", c), 
            h.scrollView.unwatch(c), this.unblock(a)), this.modals.length || this.terminate(), 
            c.trigger("uimodalclose")[d.disposable ? "remove" : "hide"]())));
        },
        clear: function() {
    ...
    colon.t = function(a) {
        ...
        c || (c = a);
        for (var d, e = b.toString().split("."), f = 0, g = e.length; g > f; ++f) {
            d = e[f];
            {
                if (!(d in c)) return;
                c = c[d];
        ...
        build: function(b, c) {
            ...
            return g = g.join("&"), b + (g.length ? (-1 === b.indexOf("?") ? "?" : "&") + g : "");
        },
